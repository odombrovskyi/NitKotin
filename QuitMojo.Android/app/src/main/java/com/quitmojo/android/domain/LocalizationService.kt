...
object LocalizationService {
    private val englishStrings = mapOf(
        ...
        "tab_overview" to "Home",
        "tab_recovery" to "Health",
        "settings_title" to "Settings",
        "settings_save" to "Save",
        "settings_cancel" to "Cancel",
        "widget_title" to "QuitMojo",
    ...
    private val ukrainianStrings = mapOf(
        ...
        "tab_products" to "Товари",
        "tab_overview" to "Головна",
        "tab_recovery" to "Здоров'я",
        "settings_title" to "Налаштування",
        "settings_save" to "Зберегти",
        "settings_cancel" to "Скасувати",
        "widget_title" to "QuitMojo",
