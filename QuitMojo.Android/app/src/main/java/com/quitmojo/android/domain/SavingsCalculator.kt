...
object SavingsCalculator {
    ...
    fun formatCurrency(amount: BigDecimal, language: com.quitmojo.android.data.model.AppLanguage): String {
    ...
    fun formatWholeCurrency(amount: BigDecimal, language: com.quitmojo.android.data.model.AppLanguage): String {
