# QuitMojo Service Roadmap

## 1. Мета продукту

Перетворити поточний застосунок QuitMojo з локального трекера прогресу на повноцінний сервіс підтримки відмови від куріння з такими властивостями:
...
QuitMojo має стати персональним сервісом для відмови від куріння, який поєднує:
...
Найкраща стратегія для QuitMojo зараз:
